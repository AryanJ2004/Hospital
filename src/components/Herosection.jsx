        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white text-gray-700 border-2 border-black rounded-3xl shadow-lg p-6 hover:scale-110 ease-in-out">
              ...
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Sophia Johnson</h3>
              <p className="text-sm">
                Specialist in Pediatrics with 10+ years of experience in child care and development.
              </p>
            </div>
            ...
            <div className="bg-white text-gray-700 border-2 border-black rounded-3xl shadow-lg p-6 hover:scale-110 ease-in-out">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full mb-4"
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Ethan Brown</h3>
              <p className="text-sm">
                Renowned Cardiologist offering comprehensive heart care and treatment plans.
              </p>
            </div>
            ...
            <div className="bg-white text-gray-700 border-2 border-black rounded-3xl shadow-lg p-6 hover:scale-110 ease-in-out">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full mb-4"
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Olivia Smith</h3>
              <p className="text-sm">
                Experienced Dermatologist specializing in skin care and cosmetic treatments.
              </p>
            </div>
            ...
            <div className="bg-white text-gray-700 border-2 border-black rounded-3xl shadow-lg p-6 hover:scale-110 ease-in-out">
              <img
                ...
                className="w-24 h-24 mx-auto rounded-full mb-4"
              />
              <h3 className="text-lg font-semibold mb-2">Dr. Liam Wilson</h3>
              <p className="text-sm">
                Orthopedic Surgeon known for expertise in bone health and joint surgeries.
              </p>
            </div>
          </div>
        </div>
